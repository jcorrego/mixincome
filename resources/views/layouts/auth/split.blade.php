        ...
        <div class="relative grid h-dvh flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
            <div class="bg-muted relative hidden h-full flex-col p-10 text-white lg:flex dark:border-e dark:border-white/10">
                ...
                <a href="{{ route('home') }}" class="relative z-20 flex items-center gap-2 text-lg font-medium" wire:navigate>
                    <img src="/images/icon-white.svg" alt="MixIncome" class="h-8 w-8" />
                    ...
                    <div class="max-w-md rounded-3xl border border-white/15 bg-white/8 p-6 shadow-xl">
                        ...
                        <div class="mt-4 space-y-4">
                            ...
                            <p class="text-sm leading-relaxed text-white/80">
                                MixIncome is a tax assistant built for professionals with income and expenses in multiple
                        ...
                        <div class="mt-6 rounded-2xl border border-white/15 bg-white/5 p-4">
                            <div class="flex items-center gap-3">
                                <span class="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-white/10">
                                    <img src="/images/icon-white.svg" alt="MixIncome" class="size-6" />
                                </span>
                                <div>
            ...
            <div class="w-full lg:p-8">
                <div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
                    <a href="{{ route('home') }}" class="z-20 flex flex-col items-center gap-2 font-medium lg:hidden" wire:navigate>
                        <img src="/images/icon-dark.svg" alt="MixIncome" class="h-9 w-9 dark:hidden" />
                        <img src="/images/icon-white.svg" alt="MixIncome" class="hidden h-9 w-9 dark:block" />
