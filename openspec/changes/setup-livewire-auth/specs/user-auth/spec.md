...
## Purpose
Authentication system for MixIncome using Laravel Fortify (headless) with Livewire views, Sanctum for API tokens, and full auth flows: login, registration, password reset, email verification, two-factor authentication, and password confirmation.
