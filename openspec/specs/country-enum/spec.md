# Specification: Country Enum

The Country enum provides a standardized set of ISO 3166-1 alpha-2 country codes for use throughout the application, ensuring data consistency for country fields.
